...
.memory-map {
    ...
    justify-content: flex-end; /* Align sections at the bottom */
}
...
.memory-section {
    ...
    align-items: flex-end; /* Align used-memory to the bottom */
...
.used-memory {
    width: 100%;
    position: absolute;
    bottom: 0; /* Position at the bottom of the memory-section */
...
.description {
    width: 30%; /* Width of the description */
    padding-left: 10px; /* Spacing */
    box-sizing: border-box;
    text-align: left;
    position: absolute; /* Positioned absolutely */
    right: -35%; /* Adjust as necessary to position outside the memory section */
